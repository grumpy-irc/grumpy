...
!define MAIN_APP_EXE "grumpy.exe"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "GrumpyChat"
...
CreateDirectory "$SMPROGRAMS\GrumpyChat"
CreateShortCut "$SMPROGRAMS\GrumpyChat\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$SMPROGRAMS\GrumpyChat\Uninstall ${APP_NAME}.lnk" "$INSTDIR\uninstall.exe"

!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\GrumpyChat\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
...
!ifndef REG_START_MENU
Delete "$SMPROGRAMS\GrumpyChat\${APP_NAME}.lnk"
Delete "$SMPROGRAMS\GrumpyChat\Uninstall ${APP_NAME}.lnk"
!ifdef WEB_SITE
Delete "$SMPROGRAMS\GrumpyChat\${APP_NAME} Website.lnk"
!endif
Delete "$DESKTOP\${APP_NAME}.lnk"

RmDir "$SMPROGRAMS\GrumpyChat"
!endif
